       ...
       {{-- <div class="hero">
          <div class="hero-left">
             <div class="hero-left__desc">
                <span class="hero-left__text-1">Le fpt c'est nous</span>
                <div class="hero-left__autre-platform">
                   <span class="hero-left__text-2">Visitez nos autres plateformes</span>
                   <div class="hero-left__platforms">
                      <span class="hero-left__platform-1">Ont site institutionel</span>
                      <span class="hero-left__platform-1">Ont produit touristique</span>
                   </div>
                </div>
             </div>
          </div>
